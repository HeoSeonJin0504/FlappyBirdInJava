...
public class Frame extends JFrame {
    ...
    PipeUp pipeUp = new PipeUp(null);
    PipeDown pipeDown = new PipeDown(null);
    ...
    public Frame() {
        ...
        pipeDown.setLocation(400, -50);
        pipeDown.setSize(1, 1);
        pnlGame.add(pipeDown);

        pipeUp.setLocation(400, 400);
        pipeUp.setSize(1, 1);
        pnlGame.add(pipeUp);
